    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=myApp.models.upload_to_notification)),
                ('dateNotificationSend', models.DateTimeField(auto_now_add=True)),
                ('idQRSend', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assigned_qr', to='myApp.item')),
